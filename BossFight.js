...
monsterContainer.appendChild(attackButtonContainer); // Add the container to the monster container
monsterContainer.appendChild(historyContainer);
          ...
          for (let player in initialInputs) {
              ...
              initialInputs[player].style.backgroundColor = player == 1 ? 'purple' : 'green';
          }
