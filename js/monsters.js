...
hitDialogues: {
  ...
  {name: "CyberBadger Cete ",
    ...
    health: adjustHealthByQuarter(650),
  ...
  {name: "Forbearer-Ramis",
    ...
    health: adjustHealthByQuarter(1305),
  ...
  {name: "PURSCERx17",
    attackType: "STRENGTH",
    health: adjustHealthByQuarter(1000),
  ...
  {name: "Aphen Neel",
    ...
    health: adjustHealthByQuarter(780),
  ...
  {name: "Curve",
    ...
    health: adjustHealthByQuarter(712),
  ...
  {name: "Tash-Nadia",
    attackType: "STRENGTH",
    health: adjustHealthByQuarter(909),
