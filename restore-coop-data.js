...
async function restoreCoopData() {
  try {
    console.log('🔄 Starting CO-OP data restoration...');
    
    // Read the restored CO-OP data from JSON file
    ...
    console.log('✨ CO-OP data restoration completed successfully!');
    
  } catch (error) {
    console.error('❌ Error restoring CO-OP data:', error);
  } finally {
    await pool.end();
  }
}
